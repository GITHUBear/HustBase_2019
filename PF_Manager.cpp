...
const RC AllocateBlock(Frame **buffer)
{
	...
	if(bf_manager.frame[min].bDirty==true){
		...
		//bf_manager.frame[min].bDirty==flase 杩欓噷搴旇淇敼鎴恌alse銆傝櫧鐒秓penFile浼氳缃紝浣嗘槸涓轰簡纭繚姝ｇ‘杩樻槸鍔犱笂銆?
		//鎴栬�呰繖閲屽彲浠ョ洿鎺ヨ皟鐢―isposeBlock锛?
	}
...
//鏀瑰悕鍙獵reate_PF_PageHandle浼氭洿濂姐�傝皝璁╃敤鏄痗锛屾病鏈夋瀯閫犲嚱鏁板憿
